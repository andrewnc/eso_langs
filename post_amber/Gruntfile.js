...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/Ddtest.st', 'src/Ddtest-Backend.st', // list all sources in dependency order
                    'src/Ddtest-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-ddtest',
