...
static void futrts_cli_entry_main(struct futhark_context *ctx)
{
    ...
    int32_t read_value_3586;
    
    if (read_scalar(&i32_info, &read_value_3586) != 0)
    ...
    if (perform_warmup) {
        ...
        r = futhark_entry_main(ctx, &result_3587, read_value_3586);
        if (r != 0)
    ...
    write_scalar(stdout, binary_output, &i32_info, &result_3587);
    printf("\n");
    ;
}
...
static int futrts_main(struct futhark_context *ctx,
                       int32_t *out_scalar_out_3585, int32_t x_3580);
...
static int futrts_main(struct futhark_context *ctx,
                       int32_t *out_scalar_out_3585, int32_t x_3580)
{
    int32_t scalar_out_3584;
    bool cond_3581 = slt32(0, x_3580);
    int32_t res_3582;
    
    if (cond_3581) {
        res_3582 = x_3580;
    } else {
        int32_t res_3583 = 0 - x_3580;
        
        res_3582 = res_3583;
    }
    scalar_out_3584 = res_3582;
    *out_scalar_out_3585 = scalar_out_3584;
    return 0;
}
int futhark_entry_main(struct futhark_context *ctx, int32_t *out0, const
                       int32_t in0)
{
    ...
    int ret = futrts_main(ctx, &scalar_out_3584, x_3580);
    
    if (ret == 0) {
        *out0 = scalar_out_3584;
    }
